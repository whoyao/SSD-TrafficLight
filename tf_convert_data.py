...
python tf_convert_data.py \
    --dataset_dir=/tmp/traffic_light \
    --output_name=traffice_light \
    --output_dir=/tmp/
```
"""
import tensorflow as tf

from datasets import traffic_light_to_tfrecords
...
def main(_):
    ...
    traffic_light_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
